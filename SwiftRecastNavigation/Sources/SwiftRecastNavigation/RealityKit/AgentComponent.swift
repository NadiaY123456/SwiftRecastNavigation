...
// Substantial modifications for SwiftRecastNavigation by Nadia Yilmaz, 2024–2025.
...
/// func createAgent (from crowd: Crowd, on entity: Entity, at position: SIMD3<Float>) -> Agent? {
