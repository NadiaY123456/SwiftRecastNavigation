...
// Originally created for SwiftNavigation (MIT) by Miguel de Icaza.
...
public class Crowd {
    ...
    public func setObstacleAvoidance (idx: Int, config: ObstacleAvoidanceConfig) {
    ...
    ///   - obstableAvoidanceType: The index of the avoidance configuration to use for the agent (set with ``setObstacleAvoidance(idx:config:)``
    ...
    /// on the ``Crowd`` instance by calling ``setObstacleAvoidance(idx:config:)``.
